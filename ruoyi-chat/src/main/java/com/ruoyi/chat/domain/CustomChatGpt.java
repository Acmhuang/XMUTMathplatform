...
import com.ruoyi.chat.domain.ChatGptMessage;
import com.ruoyi.chat.domain.ChatGptRequestParameter;
import com.ruoyi.chat.domain.ChatGptResponseParameter;
import com.ruoyi.chat.domain.Choices;
...
public class CustomChatGpt {
     ...
     * 相应超时时间，毫秒
     */
    private int responseTimeout = 1000000;
